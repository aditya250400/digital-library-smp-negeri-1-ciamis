...
export default function Show(props) {
    return (
        <>
            <div className="flex w-full flex-col space-y-12 pb-10">
            ...
            {props.book_recommendations.length > 0 && (
                <div className="flex w-full flex-col space-y-6 pb-32">
                    <div className="flex flex-col items-start justify-between gap-y-4 lg:flex-row lg:items-center">
                        <HeaderTitle
                            title={'Rekomendasi Buku'}
                            subtitle={'Buku yang direkomendasikan berdasarkan peminjaman serupa'}
                            icon={IconBooks}
                        />
                    </div>
