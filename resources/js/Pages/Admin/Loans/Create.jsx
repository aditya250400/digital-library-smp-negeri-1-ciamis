                ...
                <Card>
                    <CardContent className="p-6">
                        <form onSubmit={onHandleSubmit} className="space-y-6">
                            ...
                            <div className="grid w-full gap-1.5">
                                <Label htmlFor="due_date">Tanggal Pengembalian</Label>
                                <Input
                                    type="date"
                                    value={data.due_date}
                                ...
                                {!status && (
                                    <p className="text-xs text-muted-foreground">
                                        Jika tanggal pengembalian tidak diisi, maka tanggal pengembalian akan otomatis
                                        diatur 6 bulan dari sekarang.
                                    </p>
                                )}
